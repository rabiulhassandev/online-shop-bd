            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <div class="hidden lg:flex items-center gap-8 relative z-50">
                    ...
                    <div class="relative group py-4 -my-4">
                        <a href="{{ route('products.index') }}" class="border-b-2 pb-1 text-md transition-colors flex items-center gap-1 {{ request()->routeIs('products.*') && !in_array(request('listing'), ['discount', 'hot'])
    ? 'border-amber-500 text-amber-500'
    : 'border-transparent text-white hover:text-amber-500 group-hover:border-amber-500 group-hover:text-amber-500' }}">
