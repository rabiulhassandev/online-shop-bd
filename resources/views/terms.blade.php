...
@section('meta_description', 'আমাদের শর্তাবলী পড়ুন')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <nav class="text-sm text-gray-500 mb-8 flex items-center gap-2">
        ...
        <span>/</span>
        <span class="text-gray-900">শর্তাবলী</span>
    </nav>

    {{-- Page Title --}}
    <div class="mb-10">
        <h1 class="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">শর্তাবলী</h1>
        ...
        <div class="space-y-6">
            <div class="bg-gradient-to-br from-amber-50 to-amber-100 rounded-2xl border border-amber-200 p-6 shadow-sm">
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="{{ route('return-policy') }}" class="text-amber-600 hover:text-amber-700 font-medium flex items-center gap-2">
