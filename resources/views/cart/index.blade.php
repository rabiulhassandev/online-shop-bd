        ...
        <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="bg-white rounded-2xl border border-gray-100 p-4 flex gap-4 shadow-sm">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-xs text-gray-500 mb-2 flex gap-3">
                            ...
                            @if($item['color']) <span>কালার: <strong>{{ $item['color'] }}</strong></span> @endif
                        </div>
            ...
            <div class="lg:w-72 shrink-0">
                <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm sticky top-20">
                    ...
                    @php $deliveryCharge = (float)\App\Models\Setting::get('delivery_charge', 80); @endphp
                    ...
                    <div class="space-y-3 text-sm mb-5">
                        ...
                        <div class="flex justify-between text-gray-600">
                            ...
                            <span class="font-medium">৳{{ number_format($deliveryCharge, 0) }}</span>
                        </div>
