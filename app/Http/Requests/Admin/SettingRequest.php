...
class SettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'product_promo_text' => ['nullable', 'string', 'max:1000'],
            ...
            'delivery_fee_inside_dhaka' => ['nullable', 'numeric', 'min:0'],
            'delivery_fee_sub_dhaka' => ['nullable', 'numeric', 'min:0'],
            'delivery_fee_outside_dhaka' => ['nullable', 'numeric', 'min:0'],
